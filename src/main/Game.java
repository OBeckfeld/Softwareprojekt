...
public class Game implements Runnable {
    ...
    public Game() {
        ...
        Player player = new Player(200, 200, 80, 40, entities, keyboardInputs, tiles);
        new Enemy(100, 100, 40, 40, entities, player, tiles);

        collisions = new CollisionManager(entities, tiles);
